...
`WindowsTerminal.Settings` is the NativeAOT-safe Avalonia editor for the layered
`Terminal.Settings` model. It intentionally has no dependency on the application
...
```xml
<ProjectReference Include="..\WindowsTerminal.Settings\WindowsTerminal.Settings.csproj" />
<TrimmerRootAssembly Include="WindowsTerminal.Settings" />
```
