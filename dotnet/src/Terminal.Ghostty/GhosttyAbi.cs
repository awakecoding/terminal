...
public static class GhosttyAbi
{
    ...
    private static string ValidateCore()
    {
        ...
        {
            Architecture.X64 => "DCB3274F9D8C945AC765A11903614C5DA4BC0CC2EF4EBC23E8CD70C130B7B458",
            Architecture.Arm64 => "691A331E92D0CE17B8407DD370D26394090B14AB8A7C398DF497442293D4ED72",
            _ => throw new PlatformNotSupportedException(
                $"The Ghostty engine does not support {RuntimeInformation.ProcessArchitecture}."),
        };
        var libraryPath = Path.Combine(AppContext.BaseDirectory, "ghostty-vt.dll");
        ...
        if (abi.GetProperty("target").GetString() != expectedTarget ||
            abi.GetProperty("os").GetString() != "windows" ||
            abi.GetProperty("environment").GetString() != "msvc" ||
