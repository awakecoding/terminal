...
public static class SettingsLoader
{
    ...
    public static string ReadEmbeddedDefaults()
        => ReadEmbeddedResource("Devolutions.Terminal.Settings.defaults.json");
    ...
    [RequiresDynamicCode("Calls Devolutions.Terminal.Settings.SettingsLoader.ApplyProfileChanges(JsonObject, JsonObject, JsonObject)")]
    [RequiresUnreferencedCode("Calls Devolutions.Terminal.Settings.SettingsLoader.ApplyProfileChanges(JsonObject, JsonObject, JsonObject)")]
