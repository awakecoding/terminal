    ...
    IReadOnlyList<string> Diagnostics)
{
        ...
        Func<string, bool>? commandExists = null)
    {
        ...
        AddCommandCapability(
            ...
            "xdg-mime is not installed; wt-dotnet URI handler registration is unavailable.",
            commandExists,
            ref available,
            diagnostics);
        AddCommandCapability(
    ...
    IDesktopCommandRunner commandRunner)
{
        ...
        out string? error)
    {
        ...
        if (args.Count != 1 ||
            ...
            !uri.Scheme.Equals("wt-dotnet", StringComparison.OrdinalIgnoreCase))
        {
            return false;
        }
        ...
        {
            error = "Unsupported wt-dotnet URI activation. Use wt-dotnet:, wt-dotnet:open, or wt-dotnet://new-tab.";
            return true;
        }
    ...
    public string GetCapabilityReport()
    {
        ...
        report.AppendLine(
            $"wt-dotnet URI handler registration: {Availability(LinuxDesktopCapability.XdgMime)} " +
        ...
        string body)
    {
        ...
        startInfo.ArgumentList.Add("windows-terminal-dotnet");
        startInfo.ArgumentList.Add(
    ...
    public static ProcessStartInfo CreateNotifySendStartInfo(string title, string body)
    {
        ...
        startInfo.ArgumentList.Add("--app-name=Windows Terminal");
        startInfo.ArgumentList.Add("--icon=com.awakecoding.WindowsTerminalDotNet");
